...
public class TweetWebView extends AppCompatActivity {

    @BindView(R.id.wvTweetLink)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tweet_web_view);
    ...
    private void SetupWebView() {
        ...
        wvArticleDetails.setWebViewClient(new TweetLinkBrowser());
    ...
    private class TweetLinkBrowser extends WebViewClient {
